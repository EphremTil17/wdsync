...
def test_install_shell_assets_writes_fish_functions_and_completion(
    ...
    monkeypatch.setattr("wdsync.shell._default_paths", fake_default_paths)
    monkeypatch.setattr("wdsync.shell._render_completion", fake_render_completion)
